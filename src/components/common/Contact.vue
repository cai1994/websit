<template>
    <div class="Process">
       <div class="upDiv">
            <div class="header">
                <p class="titleCN">砍价流程</p>
                <p class="titleEN">Bargain Service</p>
            </div>
            <div class="content">
              <div class="imgText">
       ...
       <div class="downDiv">
            <div class="header">
                <p class="titleCN">拼团流程</p>
                <p class="titleEN">Sroup Service</p>
            </div>
  ...
  .upDiv {
    ...
    .content {
      ...
      .arrow {
        ...
        top: 0%;
        left: 0px;
        animation: arrowMove 1s alternate infinite;
        .arrowImg1 {
          width: auto;
          height: 4vw;
        }
